...
function addBlog(event) {
  ...
  const inputdimulai = document.getElementById("input-blog-dimulai").value;
  const inputdiakhiri = document.getElementById("input-blog-diakhiri").value;
  ...
  const data = {
    title: inputTitle,
    dimulai: inputdimulai,
    diakhiri: inputdiakhiri,
